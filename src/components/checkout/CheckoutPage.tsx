    ...
    return (
        <>
            <div className="checkout-page">
                ...
                <div className="checkout-layout">
                    ...
                    <div className="checkout-form-col">
                        ...
                        {/* Datos de facturación (Incluye dirección primaria) */}
                        <section className="checkout-section">
                            ...
                            <Field label="Nombre de la empresa (opcional)" field="company" form={form} errors={errors} set={set} />
                            ...
                            <Field label="Teléfono" field="phone" form={form} errors={errors} set={set} type="tel" required />

                            {/* Checkbox de Envío Diferente */}
                            <label className="checkbox-different-address">
                        ...
                        {form.ship_to_different_address && (
                            <section className="checkout-section shipping-section">
                                ...
                                <div className="fields-grid">
                                    <Field label="Ciudad" field="shipping_city" form={form} errors={errors} set={set} required />
                                    <Field label="Departamento" field="shipping_state" form={form} errors={errors} set={set} />
                                </div>
                        ...
                        {/* Notas */}
                        <section className="checkout-section no-border">
                            <h2 style={{ fontSize: '1rem', color: '#1a1a1a' }}>NOTAS DEL PEDIDO (OPCIONAL)</h2>
                            <textarea
                            ...
                            <div className="payment-methods-accordion">
                                ...
                                <div className={`payment-method-box ${form.payment_method === 'addi' ? 'active' : ''}`}>
                                    <label className="payment-method-header">
                                        ...
                                        <span className="addi-text-logo addi-blue">Addi</span>
                                    </label>
            ...
            <style>{`
                ...
                .checkout-layout {
                    display: grid;
                    grid-template-columns: 1fr 480px; /* Columna derecha más ancha para las cajas de pago */
                    gap: 60px;
                    max-width: 1200px;
                    margin: 0 auto;
                    align-items: start;
                ...
                .field input:focus,
                .checkout-page textarea:focus { border-color: #999; background: #fff; }
